...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ///firebaseAuth.signOut(); Adicionar botao Logout na View
        ...
        listener = new FirebaseAuth.AuthStateListener(){
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null && !flagUsuarioLogado) {
                    ...
                    client.cadastrarCelular(user.getEmail(), token);
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                Snackbar.make(campoEmail, "Acesso nao autorizado, verifique suas informaçoes", Snackbar.LENGTH_SHORT).show();
                            }
                        }
                    });
        } else {
